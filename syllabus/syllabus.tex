...
\subsubsection*{13 - \textit{Logistic Regression (Binary, Ordered, Multinomial)} (11/15)}
\begin{itemize}
\item \textbf{Topic(s)}:  formal models, diagnostics, assumptions
...
\subsubsection*{15 - \textit{Factor Analysis; Reliability; Final Presentations} (11/29)}
\begin{itemize}
...
\subsubsection*{16 - \textit{Count Models; Intro to Time-Series, Multilevel Modeling, and Structural Equation Modeling; Final Presentations}}
\begin{itemize}
...
\subsubsection*{Finals Week - \textit{Final Presentations} (12/13, 7:30pm--9:20pm)}
\begin{itemize}
